...
final class GatewayChargeExtension implements QueryCollectionExtensionInterface, QueryItemExtensionInterface
{
    ...
    public function addFilter(QueryBuilder $queryBuilder, string $resourceClass)
    {
        ...
        // Filter by the user based on the relationship with Checkout or Accounting
        $queryBuilder
    ...
    public function applyToCollection(QueryBuilder $queryBuilder, QueryNameGeneratorInterface $queryNameGenerator, string $resourceClass, \ApiPlatform\Metadata\Operation|null $operation = null, array $context = []): void
    {
        $this->addFilter($queryBuilder, $resourceClass);
    }

    public function applyToItem(QueryBuilder $queryBuilder, QueryNameGeneratorInterface $queryNameGenerator, string $resourceClass, array $identifiers, \ApiPlatform\Metadata\Operation|null $operation = null, array $context = []): void
    {
        $this->addFilter($queryBuilder, $resourceClass);
    }
}
