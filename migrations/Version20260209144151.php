...
final class Version20260209144151 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'OAuth2 integration via thephpleague/oauth2-server-bundle';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE video_src video_src LONGTEXT DEFAULT NULL, CHANGE video_thumbnail video_thumbnail LONGTEXT DEFAULT NULL, CHANGE video_cover video_cover LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project CHANGE video_src video_src TEXT DEFAULT NULL, CHANGE video_cover video_cover TEXT DEFAULT NULL, CHANGE video_thumbnail video_thumbnail TEXT DEFAULT NULL');
    }
}
